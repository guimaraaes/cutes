...
- Caso 5: Iniciando no estado de decisão de ativação, ao decidir acionar o motor e em seguida decidir cancelar o acionamento, o componente não deve ser acionado e todos os componentes são desligados;
- Caso 6: Iniciando no estado de decisão de ativação, ao decidir acionar o motor este deve ser acionado por 0,2 segundos. Em seguida todos os componentes são desligados.
