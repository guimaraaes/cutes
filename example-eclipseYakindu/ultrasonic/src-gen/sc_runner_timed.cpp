...
void TimedSctUnitRunner::setTimer(sc::timer::TimedInterface* statemachine, sc_eventid event, sc_integer time_ms, sc_boolean isPeriodic)
{
	SctTimer timer(statemachine, time_ms, isPeriodic, event, 0, false);
	insert_timer(timer);
}

void TimedSctUnitRunner::unsetTimer(sc::timer::TimedInterface* statemachine, sc_eventid event)
{
